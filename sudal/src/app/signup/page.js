export default function Register(){
    ...
    return(
        <div className='mt-[90px] flex flex-col items-center w-auto h-[121px] gap-y-[8px]'>
            <form method="POST" action="/api/auth/signup">
                <p className="mb-4 text-center text-xl">회원가입</p>
                <input 
                ...
                <br/>
                <br/>
                <p className="mb-4 text-center text-xl">추가입력 사항</p>
                <input 
                ...
                <br/>
                <input 
                    type='number' name = 'teachingExperience'
                    className={inputStyle}
                    placeholder="과외경력"/>
                <br/>
                <br/>
            ...
            <p className="mt-[200px]">이용약관 | 개인정보처리방침<br/>Copyright © SOODAL All rights reserved.</p>
