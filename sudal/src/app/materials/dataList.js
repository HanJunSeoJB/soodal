...
export default function DataList() {
    return (
        <div className="px-[250px] bg-white">
            <div className="relative flex justify-center row border-black border-b border-dashed pb-[41.5px] mt-[20.5px] font-['Gsans']">
                {/* 임시 이미지 */}
                ...
                <button className=
                "absolute right-0 rounded-full bg-blue h-fit w-fit px-3.5 py-1 text-white font-['PretendardMedium'] mt-9">방문하기</button>
            </div>
        </div>
    )
}
